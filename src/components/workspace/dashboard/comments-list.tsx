...
const Comment: React.FC<CommentProps> = ({ name, title, message }) => {
  return (
    <div className="w-full h-8 flex items-center bg-gray-100 rounded-lg shadow-sm hover:bg-gray-200 transition overflow-hidden dark:bg-darkBg">
...
const CommentsList = () => {
  ...
  return (
    <div className="w-full  bg-white rounded-lg shadow-md p-2 space-y-2 mt-2 overflow-hidden dark:bg-darkBg">
      <div className="font-semibold text-sm text-gray-500 dark:text-gray-300">New Comments</div>
