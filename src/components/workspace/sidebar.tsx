      ...
      <div className="relative">
        <div className="flex items-center justify-between p-3 rounded-md cursor-pointer">
          <div className="flex items-center h-2 sm:h-10 md:h-10 lg:h-10 gap-4">
            {!isCollapsed && (
              <h2 className="text-md text-black ml-2 h-5 w-11/12 overflow-hidden text-ellipsis whitespace-nowrap dark:text-gray-300">
                {main?.name}
              </h2>
            )}
          </div>
          <IoIosArrowDown
            className={`text-black flex-shrink-0 transform transition-transform duration-300 cursor-pointer dark:text-gray-300 ${
