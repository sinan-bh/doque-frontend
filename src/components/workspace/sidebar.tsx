...
const Sidebar: React.FC = () => {
  ...
  const sidebarItems = [
    { icon: <AiFillHome className='text-xl text-black mr-3' />, label: 'Home', href: '/home' },
    { icon: <RiDashboardFill className='text-xl text-black mr-3' />, label: 'Dashboard', href: '/w/id/dashboard' },
    { icon: <BsFillPeopleFill className='text-xl text-black mr-3' />, label: 'Members', href: '/w/id/members' },
    { icon: <FaCalendar className='text-xl text-black mr-3' />, label: 'Calendar', href: '/w/id/calendar' },
    { icon: <AiFillMessage className='text-xl text-black mr-3' />, label: 'Message', href: '' },
