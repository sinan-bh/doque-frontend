...
const ProfileSettings: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            {/* Profile Section */}
            <div className="flex w-full rounded-lg max-w-6xl mx-auto overflow-hidden shadow-md"> 
            ...
            {/* Form Section */}
            <div className="max-w-6xl mx-auto p-12 bg-white rounded-lg shadow-md relative"> 
                    ...
                    <div className="flex space-x-8">
                        ...
                        <div className="flex-1 flex flex-col justify-between space-y-4">
                            ...
                            <div className="mt-auto">
                                <button
                                    type="submit"
                                    className="px-8 py-3 bg-blue-500 text-white rounded-lg shadow-sm hover:bg-blue-600 transition duration-200"  
                                >
                                    Save Changes
                                </button>
                            </div>
