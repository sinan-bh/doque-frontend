...
export default function WorkspaceCard({
  ...
  return (
    <li
      key={workspace._id}
      className="bg-white dark:bg-gray-800 p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:border-blue-500 dark:hover:border-blue-400"
    >
      <Link href={`/admin/workspace/${workspace._id}`}>
        <div className="cursor-pointer flex items-start space-x-4">
          <div className="flex-shrink-0 bg-blue-100 dark:bg-blue-800 p-3 rounded-full">
            <FaBriefcase className="text-blue-500 dark:text-blue-300 w-6 h-6" />
          </div>
