  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="pl-10 pr-4 py-2 w-72 border border-gray-300 dark:border-gray-500 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
    </div>
  );
};
