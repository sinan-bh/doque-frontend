  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-grow justify-between items-center mt-20 px-24">
        {/* Left Side - Question and Options in a Box */}
        <div className="w-full md:w-1/3 p-8 bg-transparent space-y-8">
          ...
          <div className="space-y-4">
            {options.map((option) => (
              <button
                key={option.label} // Use a unique key for each option
                onClick={() => onContinue(option.label)} // Pass the selected option to the parent component
          ...
          <button
            onClick={() => onContinue("Skipped")} // Pass "Skipped" if the Skip button is clicked
