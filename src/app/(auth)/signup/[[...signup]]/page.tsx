                ...
                <div className="bg-white rounded-2xl shadow-2xl flex w-full max-w-4xl">
                    <div className="w-1/2 p-10 flex flex-col justify-between">
                        <div>
                            ...
                            <p className="mb-6 text-gray-500">Please fill in the details below to create your account.</p>
                        </div>
                        <Formik
                            initialValues={{
                                firstName: "",
                    ...
                    <div className="w-1/2 bg-green-500 text-white rounded-tr-2xl rounded-br-2xl flex flex-col justify-center items-center p-10 relative">
                        ...
                        <h2 className="text-2xl font-bold mb-4 text-center">Welcome to Doque!</h2>
                        <Image
                            width={1024}
                            height={768}
                        ...
                        />
                        <p className="mb-2 text-center mt-4">Already have an account? Sign in to continue.</p>
                        <a href="/signin" className="border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-green-500">Sign In</a>
                    </div>
                </div>
            </main>
        </div>
